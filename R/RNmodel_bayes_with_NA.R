...
## read stuff ##
rm(list=ls(all=TRUE))
data<-read.csv("data/All_widedata/muntjac_datawide_n.csv",header=TRUE, strip.white=TRUE)
sampcovs<-read.csv("data/muntjac_datawide_camhour.csv",header=TRUE, strip.white=TRUE)
datalong<-read.csv("data/All_longdata/muntjac_long.csv",header=TRUE, strip.white=TRUE) 
